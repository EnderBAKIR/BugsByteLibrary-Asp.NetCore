...
namespace Repository.Layer.Migrations
{
    ...
    [Migration("20240307134008_opentowork_ısconfirmedbool")]
    partial class opentowork_ısconfirmedbool
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Layer.Models.Blog", b =>
                {
                    ...
                    b.Property<bool>("InformationBlog")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.Layer.Models.OpenToWork", b =>
                {
                    b.HasOne("Core.Layer.Models.AppUser", "AppUser")
                        .WithMany("OpenToWorks")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Core.Layer.Models.Hiring", "Hiring")
                        .WithMany("OpenToWorks")
